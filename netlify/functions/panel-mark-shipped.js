/**
 * panel-mark-shipped.js — Netlify Function
 * Oznacza zamówienie jako wysłane przez dodanie tagu 'wysłano' w Shopify.
 *
...
exports.handler = async (event) => {
    ...
    try {
        ...
        // 2. Dodaj tag 'wysłano' jeśli jeszcze nie ma
        if (!currentTags.includes('wysłano')) {
            currentTags.push('wysłano');
        }
