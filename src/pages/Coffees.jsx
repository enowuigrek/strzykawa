    ...
    return (
        <div className="min-h-screen bg-primary pt-20">
            <div className="container mx-auto px-4 py-8">
                {/* Hero Section */}
                <div className="relative bg-gradient-to-br from-primary-light/60 to-primary/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8 mb-8 overflow-hidden">
                    {/* Background Pattern */}
                    ...
                    <div className="relative z-10 text-center max-w-4xl mx-auto">
                        ...
                        <div className="flex items-center justify-center gap-4 flex-wrap">
                            <button
                                className={`group relative inline-flex items-center gap-3 px-6 py-3 rounded-xl font-semibold transition-all duration-300 overflow-hidden ${
                                    showFilters
                            ...
                            >
                                <div className={`p-2 rounded-lg ${showFilters ? 'bg-white/20' : 'bg-accent/20'} transition-colors duration-300`}>
                    ...
                    {activeFiltersCount}
                            ...
                            {hasActiveFilters && (
                                <button
                                    className="inline-flex items-center gap-2 px-4 py-3 rounded-xl bg-red-500/20 text-red-300 border border-red-500/30 hover:bg-red-500/30 transition-all duration-300 font-semibold"
                ...
                <div className={`overflow-hidden transition-all duration-500 ease-out ${
                    ...
                    <div className="bg-gradient-to-r from-primary-light/50 to-primary/50 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    id="country-filter"
                                    className="w-full px-4 py-3 bg-primary-dark/50 border border-white/20 rounded-xl text-white focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all duration-300"
                ...
                {/* Results Summary */}
                <div className="flex items-center justify-between mb-8 p-4 bg-primary-light/30 rounded-xl border border-white/10">
                    ...
                    {hasActiveFilters && (
                        <div className="flex items-center gap-2 text-sm">
                            ...
                            <span className="px-3 py-1 bg-accent/20 rounded-full text-accent font-medium">
                {activeFiltersCount}
              </span>
                        </div>
                    )}
                ...
                {filteredCoffees.length > 0 ? (
                    ...
                    <div className="text-center py-16">
                        <div className="max-w-md mx-auto">
                            <div className="mb-6">
                                <div className="inline-flex items-center justify-center w-24 h-24 bg-primary-light/50 rounded-full border border-white/10">
                            ...
                            <button
                                className="inline-flex items-center gap-3 px-6 py-3 bg-accent hover:bg-accent/80 text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-accent/25"
                                onClick={clearFilters}
                            >
                                <FaTimes className="w-4 h-4" />
                                Wyczyść filtry
