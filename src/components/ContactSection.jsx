...
function ContactSection() {
  ...
  const amenities = [
    { icon: FaWifi, label: 'Darmowe WiFi', color: 'text-blue-400' },
    { icon: FaParking, label: 'Parking w pobliżu', color: 'text-green-400' },
    { icon: FaCoffee, label: 'Takeaway', color: 'text-amber-400' },
    { icon: FaRoute, label: 'Dostępne komunikacją', color: 'text-purple-400' },
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            ...
            <div className="space-y-8">
              ...
              {/* Address */}
              <div className="group p-6 bg-gradient-to-br from-primary-light/50 to-primary/50 backdrop-blur-sm border border-white/10 rounded-2xl hover:shadow-lg hover:shadow-white/5 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 p-3 bg-accent/20 rounded-xl border border-accent/30 group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="group p-6 bg-gradient-to-br from-primary-light/50 to-primary/50 backdrop-blur-sm border border-white/10 rounded-2xl hover:shadow-lg hover:shadow-white/5 transition-all duration-300">
                  ...
                  <a
                      ...
                      className="text-muted hover:text-blue-400 transition-colors duration-300 font-medium"
                  >
                    +48 668 011 806
                  </a>
                </div>
            ...
            <div className="relative">
              <div className="relative h-96 lg:h-full min-h-[400px] bg-gradient-to-br from-primary-light/50 to-primary/50 rounded-2xl overflow-hidden border border-white/10 shadow-lg">

                {/* Map Header */}
                <div className="absolute top-4 left-4 right-4 z-10">
                  <div className="bg-primary-dark/90 backdrop-blur-md border border-white/20 rounded-xl p-3">
                ...
                {/* Map Overlay */}
                <div className="absolute inset-0 pointer-events-none bg-gradient-to-t from-primary-dark/20 via-transparent to-transparent rounded-2xl"></div>
              </div>
            </div>
          </div>

          {/* Amenities */}
          <div className="bg-gradient-to-r from-primary-light/30 to-primary/30 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              ...
              {amenities.map((amenity, index) => {
                ...
                return (
                    <div key={index} className="text-center group">
                      <div className="inline-flex items-center justify-center w-16 h-16 bg-white/10 border border-white/20 rounded-2xl mb-3 group-hover:scale-110 group-hover:bg-white/20 transition-all duration-300">
                        <Icon className={`w-7 h-7 ${amenity.color}`} />
                      </div>
                      <p className="text-sm font-medium text-muted group-hover:text-white transition-colors duration-300">
                        {amenity.label}
                      </p>
                    </div>
                );
          ...
          <div className="text-center mt-12">
            <div className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-accent to-muted hover:from-muted hover:to-accent text-white font-semibold rounded-2xl transition-all duration-500 hover:shadow-lg hover:shadow-accent/25 hover:scale-105 cursor-pointer">
