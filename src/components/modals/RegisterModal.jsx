                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-primary-dark/50 border border-white/20 text-white placeholder-muted/70 focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all duration-300"
                            placeholder="Jan"
                            required
                        />
                    </div>
                ...
                <div className="mb-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className="w-full pl-10 pr-4 py-3 bg-primary-dark/50 border border-white/20 text-white placeholder-muted/70 focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all duration-300"
                ...
                <div className="mb-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className="w-full pl-10 pr-12 py-3 bg-primary-dark/50 border border-white/20 text-white placeholder-muted/70 focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all duration-300"
