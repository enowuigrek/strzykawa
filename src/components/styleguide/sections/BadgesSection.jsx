            ...
            <div className="space-y-8">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-4">
                        <span
                            className="w-16 h-16 rounded-full flex items-center justify-center text-xs uppercase tracking-wider text-white"
                            style={{ backgroundColor: ROAST_TYPE_COLORS.Espresso }}
                        >
                            Espresso
                        </span>
                        <span
                            className="w-16 h-16 rounded-full flex items-center justify-center text-xs uppercase tracking-wider text-white"
                            style={{ backgroundColor: ROAST_TYPE_COLORS.Filter }}
                        >
                            Przelew
                        </span>
                    </div>
